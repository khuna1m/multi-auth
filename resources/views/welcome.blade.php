                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="float-right">
                                <button  onclick="location.href='{{ url('login') }}'" type="button" class="btn btn-primary btn-lg">Sign in as User </button>
                            </div>
                        </div>

                        <div class="p-6">
                            <div class="flex float-center">
                                <button  onclick="location.href='{{ url('admin/login') }}'" type="button" class="btn btn-secondary btn-lg">Sign in as Admin</button>
                            </div>
                        </div>
                    </div>
                </div>
